    ...
    <section className='container mx-auto mb-8' id='news'>
      ...
      <div className='border-b-2 mb-6'>
        <div className='flex items-center gap-x-20 mb-11 px-16'>
          ...
          <a className='group' href='https://www.justice.gov/usao-sdny/pr/founders-and-ceo-cryptocurrency-mixing-service-arrested-and-charged-money-laundering' target='__blank'>
            <p className='mb-5 text-4xl font-bold transition-color duration-300 group-hover:text-red'>Founders and CEO <br /> <span className='text-red transition-color duration-300 group-hover:text-white'>of cryptocurrency</span></p>
      ...
      <div className='border-b-2 mb-10'>
        ...
        <a className='flex justify-between items-center gap-x-12 mb-10 px-4 group' href='https://www.justice.gov/usao-sdny/media/1349321/dl' target='__blank'>
          <p className='text-4xl text-red font-bold group-hover:text-white group-hover:-skew-x-12 transition-all duration-300'>indictment</p>
          <div className='h-16 flex gap-x-4 group-hover:-skew-x-12 transition-transform duration-300'>
      ...
      <div className="px-2">
        ...
        <div className="flex gap-x-7 mb-8">
          ...
          <div className="basis-7/12 pe-10 border-e-2">
            <p className='mt-2 mb-5 text-4xl font-bold'><span className="text-red">fbi </span>public service announcement:</p>
            ...
            {/* #freesamourai */}
            <a className='mb-4 pb-4 block text-8xl font-stranger text-red text-end border-b-2 border-white hover:text-white transition-color duration-300' href='https://ronindojo.io/freesamourai/' target='__blank'>#freesamourai</a>
            {/* more news */}
          ...
          <div className='basis-5/12'>
            ...
            <a className='block mb-8 group border-b-2' href="">
              <p className='mb-5 font-bold text-4xl transition-color duration-300 group-hover:text-red'>samourai <span className='text-red transition-color duration-300 group-hover:text-white'>wallet </span>founders</p>
              <p className='mb-10 text-3xl font-mono'>Arrested and Charged With Money Laundering.</p>
            </a>
            <a className='block group' href="">
              <p className='mb-5 font-bold text-4xl transition-color duration-300 group-hover:text-red'>doj arrests <span className='text-red transition-color duration-300 group-hover:text-white'>bitcoin </span>wallet</p>
        ...
        <div className='flex gap-x-10 items-stretch'>
          <div className='basis-5/12 border-y-2 py-8'>
            ...
            <p className='mb-5 text-4xl font-bold transition-color duration-300 group-hover:text-red'>The arrest of <br /> <span className='text-red transition-color duration-300 group-hover:text-white'>Samourai Wallet</span></p>
